...
struct MemoryCard: View {
            ...
            VStack(alignment: .leading, spacing: 14) {
                HStack(alignment: .center, spacing: 14) {
                    VStack(alignment: .leading, spacing: 10) {
                        ...
                        StatPillRow {
                            StatPill(
                                label: L10n.memoryUnreclaimableLabel,
                                value: SystemFormat.percent(memory.unreclaimableFraction, decimals: 0),
                                tint: pressureTint,
                                reduceMotion: reduceMotion
                            )
                ...
                StatLegend(
                    items: [
                        .init(
                            label: L10n.memoryAppsLabel,
                            value: legendValue(memory.appMemory),
                            color: SystemPalette.accent
                        ),
                        .init(
    ...
    private var pressureTint: Color? {
        let value = memory.unreclaimableFraction
