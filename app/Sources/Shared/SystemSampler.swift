...
enum SystemSampler {
    ...
    static func memoryStats() -> MemoryStats {
        ...
        // Uygulama belleği: iç (anonim) sayfalardan boşaltılabilir
        // (purgeable) olanlar düşülüyor — Etkinlik İzleyicisi'nin
        // "Uygulama Belleği" satırıyla aynı hesap. `UInt64` çıkarması
        // taşmasın diye önce büyüklük karşılaştırılıyor.
